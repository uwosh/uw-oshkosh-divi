				...
				<article id="post-0" <?php post_class( 'et_pb_post not_found' ); ?>>
					...
					<p>
						...
						if (!isset($_SERVER['HTTP_REFERER'])) {
							...
							$failure_message .= "Invalid link: " . $website . $_SERVER['REQUEST_URI'] . "\n";
						...
						echo " " . $website . $_SERVER['REQUEST_URI']; ?>. Unfortunately, this page doesn't exist. <?php echo $casemessage; ?>  You can click back 
