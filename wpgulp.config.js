...
module.exports = {
	...
	// Project options.
	projectURL: 'uwoshdev.local', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	imgDeploy: './dist/assets/images/', // Destination folder for optimized images for the deployment build.
